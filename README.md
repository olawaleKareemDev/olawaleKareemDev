...
<h1 align="center">
  Let's Connect and Collaborate on Scalable Solutions! ☁️
</h1>
...
areas_of_expertise:
  [
    "Cloud Infrastructure Design (IaaC & Serverless)",
    "Container Orchestration (Kubernetes/EKS/GKE)",
    "Advanced CI/CD Implementation (GitOps)",
    "System Observability (Monitoring, Logging, Tracing)",
    "Security & Compliance Automation (DevSecOps)",
    "Performance Optimization and Site Reliability Engineering (SRE)",
  ]
technical_leadership:
  [
    "Mentoring junior engineers on cloud best practices and automation.",
    "Driving the adoption of Infrastructure as Code (Terraform/Ansible).",
    "Architecting multi-region, highly available, and fault-tolerant systems.",
